...
struct StdIntList {
  ...
  */
  ...
  double cutoff_d;/**<@brief Cutoof for the DMX in wannier90, input from file Kazuma Nakamura*/
  double cutoff_length_t; /**<@brief Cutoff for R in wannier90, input from file.*/
  double cutoff_length_U; /**<@brief Cutoff for R in wannier90, input from file.*/
  double cutoff_length_J; /**<@brief Cutoff for R in wannier90, input from file.*/
  double cutoff_length_D; /**<@brief Cutoff for R in wannier90, input from file. Kazuma Nakamura*/
  int cutoff_tR[3];
  int cutoff_UR[3];
  int cutoff_JR[3];
  int cutoff_DR[3]; /*Kazuma Nakamura*/ 
#if defined(_HPhi)
  /*
  HPhi modpara
  */
