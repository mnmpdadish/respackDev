...
ifort -O2 -qopenmp -xHost -debug full -check all -warn all -traceback -g -c search_Rmin.f90  
...
ifort -O2 -qopenmp -xHost -debug full -check all -warn all -traceback -g -c sub_make_eig.f90  
...
ifort -O2 -qopenmp -xHost -debug full -check all -warn all -traceback -g -o transfer_analysis transfer_analysis.o m_rd_dat_mvmc.o est_nkbi.o truncation.o make_eig.o make_kdata.o sub_make_eig.o util.o make_grd.o search_Rmin.o m_tetrahedron_20170325.o calc_dos.o sub_mkidx.o est_ef.o wrt.o -lmkl_intel_lp64 -Wl,--start-group -lmkl_intel_thread -lmkl_core -Wl,--end-group -liomp5 -lpthread 
