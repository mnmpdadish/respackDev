...
END 
!---
subroutine make_eps(NTG,NTGQ,ne,itrs,NG,LGtmp,RWtmp,rginvtmp,pgtmp,L1,L2,L3,packtmp,epsirr,epsmk,iqir) 
implicit none 
!in
integer::iqir
integer::NTG,NTGQ,itrs,NG,ne,L1,L2,L3 
integer::LGtmp(3,NTG) 
integer::RWtmp(3) 
real(8)::rginvtmp(3,3) 
integer::pgtmp(3) 
integer::packtmp(-L1:L1,-L2:L2,-L3:L3) 
!complex(8)::epsirr(NTGQ,NTGQ,ne) 
complex(4)::epsirr(NTGQ,NTGQ,ne)!20180317 
!local 
...
!out 
!complex(8),intent(out)::epsmk(NTGQ,NTGQ,ne) 
complex(4),intent(out)::epsmk(NTGQ,NTGQ,ne)!20180317 
!
epsmk(:,:,:)=0.0d0 
select case(itrs) 
...
do ig=1,NG 
 ...
 do jg=1,NG 
  ...
  phase=tpi*(dble(i1)*dble(pgtmp(1))+dble(j1)*dble(pgtmp(2))+dble(k1)*dble(pgtmp(3))) 
  pf2=exp(ci*phase) 
  write(6,'(a,x,3i5)')'iig jjg,iqir',iig,jjg,iqir   
  write(6,'(a,x,5i5)')'jjg,i3,j3,k3,iqir',jjg,i3,j3,k3,iqir  
