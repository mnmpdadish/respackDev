module m_wrt_mvmc  
  implicit none
contains
subroutine wrt_mvmc_hr(Na1,Na2,Na3,n_occ,HR,WR) 
  implicit none 
...
subroutine wrt_mvmc_SK_BAND_DISP(Ndiv,N_sym_points,NSK_BAND_DISP,SK_BAND_DISP) 
  ...
  enddo 
  return
end subroutine wrt_mvmc_SK_BAND_DISP 
!
subroutine wrt_mvmc_SK0(NTK,SK0)
  ...
  enddo 
  return
end subroutine wrt_mvmc_SK0 
!
subroutine wrt_mvmc_ef(FermiEnergy) 
  implicit none 
